...
function Form() {
  ...
  <form action="" onSubmit={handleSubmit}>
    ...
    className={`form-control ${errors.name && 'is-invalid'}`} onChange={handleChange}/>
    ...
    {errors.email && <div className='invalid-feedback'>{errors.email}</div>}
     ...
     <div className="d-flex mt-3">
      <div className="flex-grow-1 me-2">
      <input type="num" name='phone' value={formData.phone} placeholder='Phone(Optional)'
    ...
    {errors.subject && <div className='invalid-feedback'>{errors.subject}</div>}
     ...
     <textarea name="message" value={formData.message} id="" cols="30" rows="10" className={`form-control mt-3 ${errors.name && 'is-invalid'}`} onChange={handleChange} placeholder='Enter your Message Here'></textarea>
