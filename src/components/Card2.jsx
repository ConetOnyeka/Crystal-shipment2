...
function Card2() {
    const cardData =[
        ...
        {image:Pic4,title:'Warehousing',content:'Package and store your things effectively and securely to make sure them in storage, have certif...Read more'},
        {image:Pic5,title:'Door to Door Delivery',content:'Our expertise in transport management and planning allows us to design a solution. hand...Read more'},
        {image:Pic6,title:'Packaging & Storage',content:'Package and store your things effectively and securely to make sure them in storage, We... Read more'},
    ]
  return (
    <>
   <div className="row">
